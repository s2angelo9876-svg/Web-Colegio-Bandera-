    ...
    <div className="p-8 lg:p-12 bg-[#F8FAFC] min-h-screen relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16 relative z-10">
          <div className="animate-in fade-in slide-in-from-left duration-700">
              ...
              <h2 className="text-5xl font-black text-gray-900 tracking-tight leading-none mb-4">
                  Portal de <span className="text-[#003087]">Noticias</span>
              </h2>
              <p className="text-gray-400 font-bold text-lg">Administra la comunicación y novedades del plantel.</p>
          </div>
          <button 
      ...
      {showForm && (
        <div className="animate-in fade-in slide-in-from-top-6 duration-500 mb-12 relative z-10">
          <form onSubmit={handleSubmit} className="p-10 bg-white/80 backdrop-blur-xl rounded-[3rem] shadow-2xl shadow-blue-900/10 border border-white flex flex-col gap-8">
      ...
      <div className="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-white relative z-10 overflow-hidden">
        <div className="p-10 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-center gap-8 bg-slate-50/30">
            ...
            <div className="relative w-full sm:w-96 group">
                ...
                <input 
                    ...
                    className="w-full bg-white border border-gray-100 focus:border-[#003087] focus:ring-4 focus:ring-blue-50 pl-14 pr-8 py-4 rounded-2xl text-sm outline-none transition-all font-bold text-gray-700 shadow-sm"
                />
            </div>
        </div>
          ...
          <table className="w-full text-left border-separate border-spacing-y-2 px-6">
            ...
            <tbody>
              {cargando ? (
                ...
                <tr key={n.id} className="group bg-white hover:bg-blue-50/50 transition-all rounded-[2rem]">
                  ...
                  <td className="px-6 py-4">
                    <span className="font-bold text-gray-800 block truncate max-w-sm group-hover:text-[#003087] transition-colors text-base">{n.titulo}</span>
                    <p className="text-[11px] text-gray-400 font-medium mt-1 line-clamp-1">{n.contenido}</p>
                  </td>
