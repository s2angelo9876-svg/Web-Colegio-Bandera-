      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16 relative z-10">
          <div className="animate-in fade-in slide-in-from-left duration-700">
              ...
              <h2 className="text-5xl font-black text-gray-900 dark:text-white tracking-tight leading-none mb-4">
                  Portal de <span className="text-primary dark:text-blue-400">Noticias</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-7 space-y-8">
                <div className="relative space-y-2 group">
                  <label className="text-[10px] font-black uppercase text-gray-400 ml-4 tracking-[0.2em] flex items-center gap-2 group-focus-within:text-primary transition-colors">
                      <Type size={14} /> Titular de la Noticia
                  </label>
                  <input 
                    type="text" value={titulo} onChange={(e) => setTitulo(e.target.value)} required maxLength="100"
                    className="w-full bg-slate-50/50 border border-transparent focus:border-primary focus:bg-white focus:ring-4 focus:ring-blue-50 p-6 rounded-2xl outline-none transition-all font-black text-xl text-gray-800 placeholder:text-gray-300"
                ...
                <div className="space-y-2 group">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-slate-50/50 border border-transparent focus:border-primary focus:bg-white focus:ring-4 focus:ring-blue-50 p-8 rounded-[2rem] h-80 outline-none transition-all font-bold text-gray-600 leading-relaxed resize-none text-lg"
              ...
              <div className="lg:col-span-5 flex flex-col">
                <div className="space-y-2 group flex-1">
                  ...
                  <div className={`relative group h-full min-h-[350px] rounded-[2.5rem] border-2 border-dashed transition-all overflow-hidden flex flex-col items-center justify-center ${preview ? 'border-solid border-primary shadow-2xl shadow-blue-900/10' : 'border-gray-200 bg-slate-50/50 hover:bg-white hover:border-primary hover:shadow-xl'}`}>
                     {preview ? (
                       <div className="relative w-full h-full group">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-primary-dark/80 via-primary-dark/20 to-transparent opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center text-white p-8 text-center backdrop-blur-sm">
                       ...
                       <div className="flex flex-col items-center gap-4 text-gray-300 group-hover:text-primary transition-colors">
        ...
        <div className="p-10 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-center gap-8 bg-slate-50/30">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="ml-2 bg-primary text-white text-[10px] font-black px-3 py-1 rounded-lg">{noticias.length}</span>
                    </div>
                </div>
            </div>
            <div className="relative w-full sm:w-96 group">
                ...
                <input 
                    ...
                    className="w-full bg-white dark:bg-dark-input border border-gray-100 dark:border-dark-border focus:border-primary dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-50 dark:focus:ring-blue-900/30 pl-14 pr-8 py-4 rounded-2xl text-sm outline-none transition-all font-bold text-gray-700 dark:text-gray-200 shadow-sm dark:shadow-none"
                />
            </div>
        </div>
        ...
        <div className="overflow-x-auto">
              ...
              {cargando ? (
                ...
                <tr key={n.id} className="group bg-white dark:bg-dark-card hover:bg-blue-50/50 dark:hover:bg-dark-hover/50 transition-all rounded-[2rem]">
                  ...
                  <td className="px-6 py-4">
                    <span className="font-bold text-gray-800 dark:text-white block truncate max-w-sm group-hover:text-primary dark:group-hover:text-blue-400 transition-colors text-base">{n.titulo}</span>
                  ...
                  <td className="px-6 py-4 text-right last:rounded-r-[2rem]">
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0">
                      <button 
                        ...
                        className="p-3 bg-white border border-gray-100 text-primary hover:bg-primary hover:text-white rounded-xl shadow-sm transition-all"
          ...
          {!cargando && noticiasFiltradas.length === 0 && (
            <div className="py-24 text-center flex flex-col items-center justify-center gap-4">
              ...
              <button onClick={() => setBusqueda('')} className="text-primary font-black text-[10px] uppercase tracking-widest hover:underline mt-2">Limpiar búsqueda</button>
            </div>
          )}
        </div>
        ...
        {!cargando && pagination.totalPages > 1 && (
            <div className="p-6 bg-slate-50/50 border-t border-gray-50 flex justify-center items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="w-8 h-8 rounded-lg bg-primary text-white flex items-center justify-center font-black text-xs">{pagination.page}</span>
