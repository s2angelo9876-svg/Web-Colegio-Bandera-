...
function AdminTransparencia() {
    ...
    return (
        <div className="p-8 lg:p-12 bg-[#F8FAFC] min-h-screen relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16 relative z-10">
                <div className="animate-in fade-in slide-in-from-left duration-700">
                    ...
                    <h2 className="text-5xl font-black text-gray-900 tracking-tight leading-none mb-4">
                        Portal de <span className="text-[#003087]">Transparencia</span>
                    </h2>
                    <p className="text-gray-400 font-bold text-lg">Rendición de cuentas y normatividad institucional.</p>
                </div>
                <button 
            ...
            {/* Tabla Premium */}
            <div className="bg-white/70 backdrop-blur-xl rounded-[3rem] shadow-2xl shadow-blue-900/5 border border-white overflow-hidden relative z-10">
                ...
                {docsFiltrados.length === 0 && (
                    <div className="text-center py-24 bg-slate-50/30 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 font-black text-lg tracking-tight">No se encontraron documentos en esta categoría.</p>
