...
function AdminTransparencia() {
    ...
    return (
        <div className="p-8 lg:p-12 bg-surface dark:bg-dark-bg min-h-screen transition-colors duration-300 relative overflow-hidden">
            ...
            {/* Tabla Premium */}
            <div className="bg-white/70 dark:bg-dark-card/90 backdrop-blur-xl rounded-[3rem] shadow-2xl shadow-blue-900/5 border border-white overflow-hidden relative z-10">
