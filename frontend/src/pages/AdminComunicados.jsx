    ...
    return (
        <div className="p-8 lg:p-12 bg-[#F8FAFC] dark:bg-slate-900 min-h-screen transition-colors duration-300 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 relative z-10">
                {comunicados.map(c => (
                    <div key={c.id} className="bg-white/70 dark:bg-slate-800/80 backdrop-blur-sm border border-white dark:border-slate-700 p-8 rounded-[3rem] shadow-xl shadow-blue-900/5 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 relative group overflow-hidden flex flex-col h-full min-h-[320px]">
                        ...
                        <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0 z-20">
                            <button onClick={() => handleEliminar(c.id)} className="bg-white dark:bg-slate-700 text-red-500 p-4 rounded-2xl hover:bg-red-500 hover:text-white transition-all shadow-xl shadow-red-900/10 dark:shadow-none border border-red-50 dark:border-slate-600">
                                <Trash2 size={20} />
                            </button>
                        </div>
                        ...
                        <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-4 leading-tight group-hover:text-[#003087] transition-colors z-10 line-clamp-2 tracking-tight">{c.titulo}</h3>
