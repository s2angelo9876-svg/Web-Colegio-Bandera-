...
function AdminAdmisiones() {
    ...
    return (
        <div className="p-8 lg:p-12 bg-surface dark:bg-dark-bg transition-colors duration-300 min-h-screen relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16 relative z-10">
                <div className="animate-in fade-in slide-in-from-left duration-700">
                    <div className="flex items-center gap-2 text-primary font-black text-[10px] uppercase tracking-[0.3em] mb-4 bg-blue-50 w-fit px-4 py-2 rounded-full border border-blue-100/50">
                    ...
                    <h2 className="text-5xl font-black text-gray-900 dark:text-white tracking-tight leading-none mb-4">
                        Centro de <span className="text-primary dark:text-blue-400">Admisiones</span>
                    </h2>
                    ...
                    {admisiones.map(a => (
                        <div key={a.id} className="bg-white/70 dark:bg-dark-card/90 backdrop-blur-sm border border-white dark:border-dark-border p-8 rounded-[3rem] shadow-xl shadow-blue-900/5 dark:shadow-none hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 relative group overflow-hidden flex flex-col h-full">
                            ...
                            <div className="mb-6 z-10">
                                <h3 className="text-xl font-black text-primary dark:text-white mb-1 flex items-center gap-2">
                            ...
                            <div className="bg-slate-50 dark:bg-dark-card/30 p-6 rounded-2xl mb-2 flex-1 z-10 border border-slate-100 dark:border-dark-border">
                                ...
                                <a href={`tel:${a.celular}`} className="inline-flex items-center gap-2 text-primary dark:text-blue-400 hover:text-red-600 dark:hover:text-red-400 font-black text-xs uppercase tracking-widest transition-colors mt-2">
